  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
      <div className="text-center max-w-2xl mx-auto space-y-3">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-gradient-to-r from-amber-500 to-indigo-600 text-white text-xs font-bold uppercase tracking-wider shadow-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            ...
            <textarea
              ...
              className="w-full p-4 bg-slate-50 border border-slate-200 rounded-2xl text-sm font-medium focus:ring-2 focus:ring-indigo-500"
            />
          </div>
          ...
          <div className="flex flex-wrap gap-2 pt-1">
            ...
            {samplePrompts.map((prompt, idx) => (
              <button
                ...
                className="text-[11px] px-3 py-1 bg-slate-100 hover:bg-indigo-50 hover:text-indigo-600 text-slate-600 font-medium rounded-full transition"
              >
                "{prompt.slice(0, 30)}..."
              </button>
            ))}
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3.5 bg-gradient-to-r from-indigo-600 to-indigo-800 hover:from-indigo-700 hover:to-indigo-900 text-white font-bold text-sm rounded-xl shadow-lg shadow-indigo-200 transition flex items-center justify-center gap-2 disabled:opacity-50"
          >
            {loading ? (
      ...
      {recommendation && (
        <div className="bg-gradient-to-br from-indigo-900 via-slate-900 to-indigo-950 p-8 rounded-3xl text-white shadow-2xl space-y-6 animate-fade-in border border-indigo-500/20">
          <div className="flex justify-between items-start border-b border-indigo-800/80 pb-4">
          ...
          <div className="bg-white/5 p-4 rounded-2xl border border-white/10 space-y-1">
            <span className="text-xs text-indigo-300 font-medium">AI Analysis Reason</span>
            <p className="text-xs text-indigo-100/90 leading-relaxed italic">"{recommendation.reason}"</p>
          </div>
